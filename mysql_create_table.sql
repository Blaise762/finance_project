...
CREATE TABLE IF NOT EXISTS t_personal_balance (
  ...
  PRIMARY KEY (pb_id),
  UNIQUE KEY idx_subject_date (subject_id, record_date),
  FOREIGN KEY (subject_id) REFERENCES t_personal_subject(subject_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='个人资产负债数据表';

-- 插入示例数据（2025-12-31）
INSERT INTO t_personal_balance (subject_id, record_date, current_balance, remark) VALUES
(1, '2025-12-31', 1500.00, '现金留存'),
(2, '2025-12-31', 55000.00, '12月工资'),
(3, '2025-12-31', 7500.00, '双十二消费500'),
(4, '2025-12-31', 20500.00, '基金收益500'),
(5, '2025-12-31', 1000000.00, '房产估值不变'),
(6, '2025-12-31', 148000.00, '车辆折旧2000'),
(7, '2025-12-31', 2000.00, '还款1000'),
(8, '2025-12-31', 0.00, '花呗已还清'),
(9, '2025-12-31', 795000.00, '房贷月供5000'),
(10, '2025-12-31', 48000.00, '车贷还款2000');